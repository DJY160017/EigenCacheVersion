...
template <typename ExpressionType, typename DeviceType> class TensorDevice {
  public:
    ...
    EIGEN_STRONG_INLINE TensorDevice& operator=(const OtherDerived& other) {
      std::cout<<"contrib: Tensordevice = init"<<std::endl;
      std::ofstream outfile;
      outfile.open("/home/byron/Documents/workspace/NeuralNetworFloatAbnormal/simple_network/test.txt");
      outfile << "ontrib: Tensordevice = init" << std::endl;
