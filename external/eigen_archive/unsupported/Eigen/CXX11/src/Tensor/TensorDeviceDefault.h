...
struct DefaultDevice {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void* allocate(size_t num_bytes) const {
    std::cout<<"TensorDeviceDefault: allocate"<<std::endl;
    return internal::aligned_malloc(num_bytes);
  }
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void deallocate(void* buffer) const {
    std::cout<<"TensorDeviceDefault: deallocate"<<std::endl;
    internal::aligned_free(buffer);
  }
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void* allocate_temp(size_t num_bytes) const {
    std::cout<<"TensorDeviceDefault: allocate_temp"<<std::endl;
    return allocate(num_bytes);
  }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void allocate_temp(iRRAM::REAL* p, size_t n) const {
    std::cout<<"TensorDeviceDefault: allocate_temp iRRAM"<<std::endl;
    for (size_t i = 0; i < n; ++p, ++i) new (p) iRRAM::REAL();
  }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void deallocate_temp(void* buffer) const {
    std::cout<<"TensorDeviceDefault: deallocate_temp"<<std::endl;
    deallocate(buffer);
  }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void deallocate_temp(iRRAM::REAL* p, size_t n) const {
    std::cout<<"TensorDeviceDefault: deallocate_temp iRRAM"<<std::endl;
    for (size_t i = 0; i < n; ++p, ++i) p->~REAL();
  }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void memcpy(void* dst, const void* src, size_t n) const {
    std::cout<<"TensorDeviceDefault: memcpy"<<std::endl;
    ::memcpy(dst, src, n);
  }
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void memset(void* buffer, int c, size_t n) const {
    std::cout<<"TensorDeviceDefault: memset"<<std::endl;
    ::memset(buffer, c, n);
  }
